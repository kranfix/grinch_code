...
class Home extends HookWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final repo = useProvider(todoRepoProvider);
    useMemoized(() {
      repo.findAll();
    });
          ...
          children: [
            ...
            TextField(
              ...
              onSubmitted: (value) async {
                try {
                  await context.read(todoRepoProvider).createOne(value);
        ...
        onFocusChange: (focused) {
          if (focused) {
            ...
            context
                ...
                .editOne(todo, textEditingController.text);
          }
        },
        child: ListTile(
          onTap: () {
          ...
          leading: Checkbox(
            value: todo.done,
            onChanged: (value) =>
                context.read(todoRepoProvider).toggleOne(todo),
          ),
          title: isFocused
              ? TextField(
                  autofocus: true,
